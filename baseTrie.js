...
function Trie(db, root, cache) {
  ...
  this._cache = cache || levelup('', { db: memdown });
  this._getDBs = [this._cache, this._db];
  this._putDBs = [this._cache, this._db];
