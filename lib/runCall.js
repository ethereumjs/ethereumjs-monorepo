 ...
 * @param opts.enableHomestead {Boolean} set to true to enable Homestead feature set
 */
module.exports = function (opts, cb) {
  ...
  var enableHomestead = this.enableHomestead === undefined ? block.isHomestead() : this.enableHomestead
