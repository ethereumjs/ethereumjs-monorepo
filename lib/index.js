...
function VM(trie, blockchain) {
  ...
  Object.defineProperty(this, '_storageTries', {
    get: function(){
      return self.stateManager._storageTries
    },
    set: function(value){
      return self.stateManager._storageTries = value
    },
  })
...
VM.prototype.generateGenesis = function(initState, cb) {
  ...
  async.eachSeries(addresses, function(address, done) {
    ...
    self.stateManager.setAccountBalance(address, new Account(), balance, done)
