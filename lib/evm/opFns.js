  ...
  if (runState._common.hardfork() === 'constantinople') {
    ...
    if (original.equals(current)) {
      ...
      if (value.length === 0) {
        ...
        runState.eei.refundGas(runState._common.param('gasPrices', 'netSstoreClearRefund'))
      }
    ...
    if (original.length !== 0) {
      ...
      if (current.length === 0) {
        ...
        runState.eei._result.gasRefund = runState.eei._result.gasRefund.subn(runState._common.param('gasPrices', 'netSstoreClearRefund'))
    ...
    if (original.equals(value)) {
      ...
      if (original.length === 0) {
        ...
        runState.eei.refundGas(runState._common.param('gasPrices', 'netSstoreResetClearRefund'))
      } else {
        // Otherwise, add 4800 gas to refund counter.
        runState.eei.refundGas(runState._common.param('gasPrices', 'netSstoreResetRefund'))
      }
    }
