...
import blockData from './testdata/testdata-from-rpc.json'
import blockDataDifficultyAsInteger from './testdata/testdata-from-rpc-difficulty-as-integer.json'
import blockDataWithUncles from './testdata/testdata-from-rpc-with-uncles.json'
import uncleBlockData from './testdata/testdata-from-rpc-with-uncles_uncle-block-data.json'
import testDataFromRpcGoerliLondon from './testdata/testdata-from-rpc-goerli-london.json'
