...
tape('[fromRPC]: block #2924874', function (t) {
  ...
  t.test(
    ...
    function (st) {
      ...
      st.ok(
        blockFromTransactionValueAsInteger.transactions[0].value.toString() === valueAsIntegerString
      )
  ...
  t.test(
    ...
    function (st) {
      ...
      st.ok(
        blockFromTransactionGasPriceAsInteger.transactions[0].gasPrice.toString() ===
