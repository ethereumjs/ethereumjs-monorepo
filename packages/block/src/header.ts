...
export class BlockHeader {
  ...
  toJSON(): JsonHeader {
    ...
    if (this._common.isActivatedEIP(1559)) {
      ...
      jsonDict.baseFee = bigIntToHex(this.baseFeePerGas!) // deprecated alias, please use `baseFeePerGas`, will be removed in next major release
    }
  ...
  private _getHardfork(): string {
    return this._common.hardfork() || this._common.activeHardfork(this.number)
  }
