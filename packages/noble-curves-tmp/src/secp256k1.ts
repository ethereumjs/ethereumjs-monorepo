...
import { type HTFMethod, type Hasher, createHasher, isogenyMap } from './abstract/hash-to-curve.ts'
...
import { type ProjPointType as PointType, mapToCurveSimpleSWU } from './abstract/weierstrass.ts'
 ...
 */
export const hashToCurve: HTFMethod<bigint> = /* @__PURE__ */ (() => secp256k1_hasher.hashToCurve)()
