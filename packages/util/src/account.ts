 ...
 */
export const isValidAddress = (hexAddress: string): hexAddress is PrefixedHexString => {
  try {
 ...
 */
export const isValidChecksumAddress = (hexAddress: string, eip1191ChainId?: BigIntLike): boolean =>
  isValidAddress(hexAddress) && toChecksumAddress(hexAddress, eip1191ChainId) === hexAddress
 ...
 */
export const generateAddress = (from: Uint8Array, nonce: Uint8Array): Uint8Array => {
  assertIsBytes(from)
  assertIsBytes(nonce)
 ...
 */
export const isValidPublic = (publicKey: Uint8Array, sanitize = false): boolean => {
 ...
 */
export const zeroAddress = (): PrefixedHexString => bytesToHex(new Uint8Array(20))
