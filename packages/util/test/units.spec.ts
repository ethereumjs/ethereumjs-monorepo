...
describe("formatBigDecimal", () => {
  const testCases: [bigint, bigint, bigint, string][] = [
    ...
    [
      BigInt("10379773927569685"),
      BigInt("1000000000000000000"),
      BigInt("1000"),
      "0.010",
    ],
    [
      BigInt("1037977392756968"),
      BigInt("1000000000000000000"),
      BigInt("1000"),
      "0.001",
    ],
    ...
    [
      BigInt("58200000000000000"),
      BigInt("1000000000000000000"),
      BigInt("100000"),
      "0.05820",
    ],
    [
      BigInt("111103797739275696858"),
      BigInt("1000000000000000000"),
      BigInt("100000"),
      "111.10379",
    ],
  ...
  for (const [
    ...
    it(`format ${numerator} / ${denominator} correctly to ${expectedString}`, () => {
      assert.equal(
        formatBigDecimal(numerator, denominator, decimalFactor),
        expectedString,
      );
    });
  }
