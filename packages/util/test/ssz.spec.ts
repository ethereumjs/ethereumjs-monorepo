...
const withdrawalsData = [
  {
    ...
    address: hexToBytes('0000000000000000000000000000000000000000'),
    amount: BigInt('0'),
  },
  {
    index: BigInt(1),
    validatorIndex: BigInt(65536),
    address: hexToBytes('0100000000000000000000000000000000000000'),
    amount: BigInt('04523128485832663883'),
  },
  {
    index: BigInt(2),
    validatorIndex: BigInt(65537),
    address: hexToBytes('0200000000000000000000000000000000000000'),
    amount: BigInt('09046256971665327767'),
  },
  {
    index: BigInt(4),
    validatorIndex: BigInt(65538),
    address: hexToBytes('0300000000000000000000000000000000000000'),
    amount: BigInt('13569385457497991651'),
  },
  {
    index: BigInt(4),
    validatorIndex: BigInt(65539),
    address: hexToBytes('0400000000000000000000000000000000000000'),
    amount: BigInt('18446744073709551615'),
  },
  {
    index: BigInt(5),
    validatorIndex: BigInt(65540),
    address: hexToBytes('0500000000000000000000000000000000000000'),
    amount: BigInt('02261564242916331941'),
  },
  {
    index: BigInt(6),
    validatorIndex: BigInt(65541),
    address: hexToBytes('0600000000000000000000000000000000000000'),
    amount: BigInt('02713877091499598330'),
  },
  {
    index: BigInt(7),
    validatorIndex: BigInt(65542),
    address: hexToBytes('0700000000000000000000000000000000000000'),
