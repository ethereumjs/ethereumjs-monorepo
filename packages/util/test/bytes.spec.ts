...
describe("intToBytes", () => {
  it("should throw on wrong input", () => {
    ...
    assert.throws(
      () => intToBytes(<any>Number.POSITIVE_INFINITY),
      undefined,
      undefined,
      "throws on +Infinity",
    );
    assert.throws(
      () => intToBytes(<any>Number.NEGATIVE_INFINITY),
      undefined,
      undefined,
      "throws on -Infinity",
    );
    assert.throws(
      () => intToBytes(<any>Number.NaN),
      undefined,
      undefined,
      "throws on NaN",
    );
    assert.throws(
      () => intToBytes(<any>undefined),
      undefined,
      undefined,
      "throws on undefined",
    );
  ...
  it("should pass on correct input", () => {
    assert.deepEqual(
      intToBytes(0),
      hexToBytes("0x00"),
      "correctly converts 0 to a Uint8Array",
    );
    assert.deepEqual(
      intToBytes(1),
      hexToBytes("0x01"),
      "correctly converts 1 to a Uint8Array",
    );
  });
});
...
describe("intToHex", () => {
  it("should throw on wrong input", () => {
    ...
    assert.throws(
      () => intToHex(<any>Number.POSITIVE_INFINITY),
      undefined,
      undefined,
      "throws on +Infinity",
    );
    assert.throws(
      () => intToHex(<any>Number.NEGATIVE_INFINITY),
      undefined,
      undefined,
      "throws on -Infinity",
    );
    assert.throws(
      () => intToHex(<any>Number.NaN),
      undefined,
      undefined,
      "throws on NaN",
    );
    assert.throws(
      () => intToHex(<any>undefined),
      undefined,
      undefined,
      "throws on undefined",
    );
...
describe("bigIntToAddressBytes", () => {
  ...
  for (const [addressHex, addressBigInt, isSafe] of testCases) {
    it("should correctly convert", () => {
      const addressHexFromBigInt = bytesToHex(
        bigIntToAddressBytes(addressBigInt as bigint, false),
      );
      assert.equal(
        addressHex,
