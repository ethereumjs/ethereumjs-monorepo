  ...
  [
    ...
    function (runState) {
      ...
      if (dest > runState.interpreter.getCodeSize()) {
        trap(EVMError.INVALID_JUMP + ' at ' + describeLocation(runState))
      }
  ...
  [
    ...
    function (runState) {
      ...
      if (runState.interpreter.isStatic()) {
        trap(EVMError.STATIC_STATE_CHANGE)
      }
      const [key, val] = runState.stack.popN(2)
  ...
  [
    ...
    async function (runState, common) {
      ...
      if (
        ...
        trap(EVMError.INITCODE_SIZE_VIOLATION)
      }
