...
tape('Precompiles: hardfork availability', (t) => {
  t.test('Test ECPAIRING availability', async (st) => {
    ...
    const commonByzantium = new Common({ hardfork: Hardfork.Byzantium })
    ...
    const commonPetersburg = new Common({ hardfork: Hardfork.Petersburg })
    ...
    const commonHomestead = new Common({ hardfork: Hardfork.Homestead })
