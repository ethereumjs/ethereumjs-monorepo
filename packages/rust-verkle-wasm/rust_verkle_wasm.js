...
module.exports.verify_update = function(js_root, js_proof, js_key_values) {
    try {
        var ret = wasm.verify_update(addHeapObject(js_root), addHeapObject(js_proof), addBorrowedObject(js_key_values));
        return takeObject(ret);
    } finally {
...
module.exports.__wbg_BigInt_5179c5cb9cc5bfa4 = function() { return handleError(function (arg0) {
    var ret = BigInt(getObject(arg0));
    return addHeapObject(ret);
}, arguments) };

module.exports.__wbg_toString_438e03f57fe1aad9 = function() { return handleError(function (arg0, arg1) {
