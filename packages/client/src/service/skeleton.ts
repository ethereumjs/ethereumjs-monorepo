...
export class Skeleton extends MetaDBManager {
   ...
   */
  private async putBlock(block: Block, onlyUnfinalized = false): Promise<boolean> {
   ...
   */
  async getBlockByHash(hash: Uint8Array, onlyCanonical = false): Promise<Block | undefined> {
