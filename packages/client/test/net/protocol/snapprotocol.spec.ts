...
tape('[SnapProtocol]', (t) => {
  ...
  t.test('GetTrieNodes should encode/decode correctly', (t) => {
    ...
    const reqId = BigInt(1)
    const root = Buffer.from(
      '62f0952f288bb2cf58cded53d22306bf263a124c9d62c05c5b75f72ef3e8a483',
      'hex'
    )
    const paths = [[Buffer.from('0x0', 'hex')]]
    const bytes = BigInt(5000000)
  ...
  t.test('TrieNodes should encode/decode correctly', async (t) => {
    ...
    t.ok(reqId === BigInt(1), 'reqId should be 1')
    t.ok(nodes.length === 1, 'nodes should be present in response')
  ...
  t.test('TrieNodes should verify a real sample', async (t) => {
    ...
    /* eslint-disable @typescript-eslint/no-use-before-define */
    const getTrieNodesReq = RLP.decode(Buffer.from(getTrieNodesRLP, 'hex'))
    console.log('getTrieNodesReq: ' + getTrieNodesReq.toString())
    const raw = p.decode(
      p.messages.filter((message) => message.name === 'GetTrieNodes')[0],
      getTrieNodesReq
    )
...
//   root: Buffer.from("62f0952f288bb2cf58cded53d22306bf263a124c9d62c05c5b75f72ef3e8a483", "hex"),
//   paths: [
//     [Buffer.from("0x0", "hex")],
//   ],
...
const getTrieNodesRLP =
  'e901a062f0952f288bb2cf58cded53d22306bf263a124c9d62c05c5b75f72ef3e8a483c2c180834c4b40'
//  e901a062f0952f288bb2cf58cded53d22306bf263a124c9d62c05c5b75f72ef3e8a483c2c180834c4b40
const trieNodesRLP =
  ''
