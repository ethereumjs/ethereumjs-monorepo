...
describe(method, async () => {
  ...
  it('should load a valid execution', () => {
  ...
  it('should verify nonce is 0', async () => {
...
describe('call with unsupported block argument', async () => {
  const blockchain = await Blockchain.create()
