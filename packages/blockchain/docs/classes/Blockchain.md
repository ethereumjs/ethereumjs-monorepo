...
> **new Blockchain**(`opts`): [`Blockchain`](Blockchain.md)
...
has not been run. This matches the behavior of [Blockchain.iterator](Blockchain.md#iterator).
...
head can be retrieved using [Blockchain.getIteratorHead](Blockchain.md#getiteratorhead).
