...
import { type Block, createBlockFromRPC } from "@ethereumjs/block";
import { Common, Hardfork, Mainnet } from "@ethereumjs/common";
import { type VM, createVM, runBlock as runBlockVM } from "@ethereumjs/vm";
...
export async function mainnetBlocks(
