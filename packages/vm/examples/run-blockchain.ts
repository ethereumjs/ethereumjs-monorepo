...
import { Block, blockFromBlockData, blockFromRLPSerializedBlock } from '@ethereumjs/block'
...
async function main() {
  ...
  const genesisBlock = blockFromBlockData({ header: testData.genesisBlockHeader }, { common })
