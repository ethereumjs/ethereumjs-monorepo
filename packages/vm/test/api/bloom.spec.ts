...
tape('bloom', (t: tape.Test) => {
  ...
  t.test('should contain values of hardcoded bitvector', (st) => {
    ...
    const vector = hexToBytes(hex, 'hex')
  ...
  t.test('should generate the correct bloom filter value', (st) => {
    ...
    bloom.add(hexToBytes('1d7022f5b17d2f8b695918fb48fa1089c9f85401', 'hex'))
    bloom.add(hexToBytes('8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925', 'hex'))
    bloom.add(hexToBytes('0000000000000000000000005409ed021d9299bf6814279a6a1411a7e866a631', 'hex'))
    bloom.add(hexToBytes('0000000000000000000000001dc4c1cefef38a777b15aa20260a54e584b16c48', 'hex'))
    st.equal(
