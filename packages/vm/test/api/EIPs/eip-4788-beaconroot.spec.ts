...
const brootAddressString = '000F3df6D732807Ef1319fB7B8bB8522d0Beac02'
...
const brootAddress = createAddressFromString(`0x${brootAddressString}`)
...
async function runBlock(block: Block) {
  ...
  await vm.stateManager.putCode(brootAddress, hexToBytes(BROOT_CODE))
  return {
