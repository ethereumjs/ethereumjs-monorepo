...
const referenceFixturePath = path.join(
  repoRoot,
  'packages/execution-spec-tests/dev/blockchain_tests/amsterdam/v732_mixed_with_other_eips/eip7928_block_level_access_lists/block_access_lists/bal_all_transaction_types.json',
)
const defaultOutputPath = path.join(
  repoRoot,
  'packages/execution-spec-tests/dev/blockchain_tests/amsterdam/v732_mixed_with_other_eips/eip7928_block_level_access_lists/block_access_lists/bal_large_generated_fixture.json',
)
