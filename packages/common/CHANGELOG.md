...
- Add `mainnet` Prague timestamp & fork hash, PR [#3971](https://github.com/ethereumjs/ethereumjs-monorepo/pull/3971)
- `GethGenesis` TypeScript interface, PR [#3973](https://github.com/ethereumjs/ethereumjs-monorepo/pull/3973)
