...
tape('[Common]: Merge/POS specific logic', function (t: tape.Test) {
  t.test('hardforkTD()', function (st: tape.Test) {
    ...
    st.ok(c.hardforkTD(Hardfork.Merge) === BigInt(5000), 'should get the HF total difficulty')
  ...
  t.test('Pure POS testnet', function (st: tape.Test) {
    ...
    st.ok(c.hardforkTD(Hardfork.Chainstart) === BigInt(0), 'should get the HF total difficulty')
