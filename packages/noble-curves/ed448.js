...
const ED448_DEF = {
  ...
  domain: (data, ctx, phflag) => {
    ...
    return (0, utils_1.concatBytes)(
      (0, utils_1.utf8ToBytes)('SigEd448'),
...
const htf = /* @__PURE__ */ (() =>
  (0, hash_to_curve_js_1.createHasher)(
    exports.ed448.ExtendedPoint,
...
const bytes448ToNumberLE = (bytes) =>
  exports.ed448.CURVE.Fp.create((0, utils_js_1.bytesToNumberLE)(bytes) & MAX_448B)
...
function calcElligatorDecafMap(r0) {
  ...
  let s_abs = s
  if ((0, modular_js_1.isNegativeLE)(s, P)) s_abs = mod(-s)
  const s2 = s * s
...
class DcfPoint {
  ...
  static fromHex(hex) {
    ...
    if (
      !(0, utils_js_1.equalBytes)((0, utils_js_1.numberToBytesLE)(s, 56), hex) ||
      (0, modular_js_1.isNegativeLE)(s, P)
    )
    ...
    if ((0, modular_js_1.isNegativeLE)(u3, P)) u3 = mod(-u3)
  ...
  toRawBytes() {
    ...
    if ((0, modular_js_1.isNegativeLE)(ratio, P)) ratio = mod(-ratio)
...
exports.DecafPoint = (() => {
  ...
  if (!DcfPoint.BASE) DcfPoint.BASE = new DcfPoint(exports.ed448.ExtendedPoint.BASE).multiply(_2n)
  if (!DcfPoint.ZERO) DcfPoint.ZERO = new DcfPoint(exports.ed448.ExtendedPoint.ZERO)
  return DcfPoint
})()
...
const hashToDecaf448 = (msg, options) => {
  ...
  const uniform_bytes = (0, hash_to_curve_js_1.expand_message_xof)(
    msg,
    DST,
    112,
    224,
