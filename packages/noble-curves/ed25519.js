...
function ed25519_domain(data, ctx, phflag) {
  ...
  return (0, utils_1.concatBytes)(
    (0, utils_1.utf8ToBytes)('SigEd25519 no Ed25519 collisions'),
...
const ELL2_C1_EDWARDS = /* @__PURE__ */ (() =>
  (0, modular_js_1.FpSqrtEven)(Fp, Fp.neg(BigInt(486664))))() // sgn0(c1) MUST equal 0
...
const bytes255ToNumberLE = (bytes) =>
  exports.ed25519.CURVE.Fp.create((0, utils_js_1.bytesToNumberLE)(bytes) & MAX_255B)
...
class RistPoint {
  ...
  static fromHex(hex) {
    ...
    if (
      !(0, utils_js_1.equalBytes)((0, utils_js_1.numberToBytesLE)(s, 32), hex) ||
